...
class AboutBlocks < Neo::Koan
  ...
  def test_blocks_can_be_assigned_to_variables_and_called_explicitly
    ...
    # Think About It
    # Why is it better to use the add_one.call(10) method
    # Instead of the add_one[10]
    # I think the call method makes it more apparent
    # what one is doing while the [] method might be
    # confused with the array[] access method
  end
